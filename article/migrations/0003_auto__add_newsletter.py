...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('article_newsletter', (
        ...
        db.send_create_signal('article', ['Newsletter'])

        # Adding M2M table for field newsletters on 'Post'
        db.create_table('article_post_newsletters', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('post', models.ForeignKey(orm['article.post'], null=False)),
            ('newsletter', models.ForeignKey(orm['article.newsletter'], null=False))
        ))
        db.create_unique('article_post_newsletters', ['post_id', 'newsletter_id'])


    def backwards(self, orm):
        # Deleting model 'Newsletter'
        db.delete_table('article_newsletter')

        # Removing M2M table for field newsletters on 'Post'
        db.delete_table('article_post_newsletters')


    models = {
        'article.newsletter': {
            'Meta': {'ordering': "['title']", 'object_name': 'Newsletter'},
