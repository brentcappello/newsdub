...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Newsletter.created_by'
        db.add_column('article_newsletter', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Newsletter.created_by'
        db.delete_column('article_newsletter', 'created_by_id')
