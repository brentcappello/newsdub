...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field newsletters on 'Article'
        db.create_table('newsscrape_article_newsletters', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('article', models.ForeignKey(orm['newsscrape.article'], null=False)),
            ('newsletter', models.ForeignKey(orm['article.newsletter'], null=False))
        ))
        db.create_unique('newsscrape_article_newsletters', ['article_id', 'newsletter_id'])


    def backwards(self, orm):
        # Removing M2M table for field newsletters on 'Article'
        db.delete_table('newsscrape_article_newsletters')
    ...
    models = {
        'article.newsletter': {
            ...
            'publication': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['article.Publication']", 'symmetrical': 'False'}),
        ...
        'article.publication': {
            'Meta': {'ordering': "('-created_at',)", 'object_name': 'Publication'},
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'description': ('django.db.models.fields.TextField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
